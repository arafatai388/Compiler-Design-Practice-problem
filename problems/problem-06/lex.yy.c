...
static yyconst short int yy_base[19] =
    {   0,
        0,    0,   17,   18,    0,    0,   12,    0,    0,   10,
        0,    0,   18,   18,    4,    7,   11,    6
    } ;

static yyconst short int yy_def[19] =
    {   0,
       14,    1,   14,   14,   15,   15,   16,   17,   15,   16,
       10,   18,   14,    0,   14,   14,   14,   14
    } ;

static yyconst short int yy_nxt[24] =
    {   0,
        4,    5,    6,    7,    8,    9,    9,   10,   10,   13,
       10,   12,   12,   11,   12,   11,   14,    3,   14,   14,
       14,   14,   14
    } ;
